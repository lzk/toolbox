...
char* md5Calmd5cMD5FromFile(const char *s8_Path)
{
    ...
    HANDLE h_File = CreateFileA(s8_Path, GENERIC_READ, FILE_SHARE_READ, 0, 
...
char* md5Calmd5cMD5FromString(const char *s8_Input)
{
    MD5Init();
